...
+ *Download zipped directory at [s.id/data_rectangling](https://s.id/data_rectangling)*
+ *Extract the zip files into your computer*
+ *Open your RStudio and click `File - New Project - Existing Directory. Browse into the previously extracted directory and hit `Create Project`*
+ *Please open `hands-on.Rmd` and read the instruction thoroughly*
...
.pull-right[
# Thank you!
### `r icon::ii("paper-airplane")` [t.me/GNURIndonesia](https://t.me/GNURIndonesia)
### `r icon::ii("android-globe")` [r-indonesia.id](https://r-indonesia.id)
### `r icon::ii("email")` [info@r-indonesia.id](mailto:info@r-indonesia.id)
]
